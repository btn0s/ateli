...
const tokens = `
:where(.tl-container,[data-agentation-root]) {
...
.tl-theme__dark,[data-agentation-root][data-agentation-theme=dark] {
...
@media (prefers-contrast:more) { :where(.tl-container,[data-agentation-root]) { --ui-line:var(--ui-ink-2); --ui-shade:var(--ui-ink-2); --ui-highlight:var(--ui-ink-2); } }
`
...
const key = ['.ui-key', '.ui-kbd', '.tlui-kbd > span', '.tlui-slider__thumb', '.tlui-button__low', '.tlui-button__menu[data-highlighted]::after', '.tlui-dialog__footer__actions .tlui-button::after', '[data-agentation-root] [data-agentation-toolbar] > div']
const keyHover = ['.ui-key:where(:hover:not(:disabled,[aria-pressed=true]))', '.tlui-button:not(:disabled,[data-disabled]):hover::after', '[data-agentation-root] [data-agentation-toolbar] > div[role=button]:hover']
...
const well = ['.ui-well', '.ui-key:where(:active:not(:disabled))', '.tlui-button:not(:disabled,[data-disabled]):active::after', '.tlui-button[data-state=open]::after', '.tlui-zoom-menu__button[data-state=open]::after', '.tlui-page-menu__trigger[data-state=open]::after', '.tlui-menu-zone [data-state=open]::after', '.tlui-input__wrapper .tlui-input', '.tlui-page-menu__item__input', '.tlui-slider__track::after', '.tlui-slider__thumb:active', '[data-agentation-root] [data-agentation-toolbar] > div[role=button]:active']
