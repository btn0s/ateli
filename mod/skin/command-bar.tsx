...
/** A tool the script adds; `icon` is a rendered element rather than a tldraw icon name. */
export interface PersonalTool { id: string; label: string; icon: ReactNode; readonlyOk?: boolean }
/** An editor action offered in the palette. */
export interface PaletteCommand { id: string; label: string; icon: ReactNode; run(editor: Editor, trackEvent?: TLUiEventHandler): void; readonlyOk?: boolean }
