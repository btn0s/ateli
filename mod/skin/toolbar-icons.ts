import strip from './assets/icons/toolbar-strip.png'

// Cell order in mod/skin/assets/icons/toolbar-strip.png (128px cells, left to right). Only the main tool row gets the art pass;
