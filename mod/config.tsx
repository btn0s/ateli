...
import { AteliEdgeOverlay, AteliEdgeShapeUtil, AteliNodeShapeTool, AteliNodeShapeUtil, ateliNodeIcon, createAteliNode, seedAteliGraph, seedCharacterMotionGraph } from './graph/ateli-node-shape'
import { catalog, watchCatalog, type AteliCategory } from './graph/ateli-tools'
...
const ateliCategories: AteliCategory[] = ['Input', 'Image', 'Video', 'Mesh', 'Utility', 'Output']
...
function commands(): PaletteCommand[] {
	...
	return [
		...
		{ id:'ateli-seed-character-motion', label:'Create character motion graph', icon:ateliNodeIcon, run:seedCharacterMotionGraph },
