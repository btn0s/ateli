    ...
    <ContextMenuPrimitive.Portal>
      ...
      >
        <ContextMenuPrimitive.Popup
          ...
          className={cn(
            "z-[300] max-h-(--available-height) min-w-40 overflow-x-hidden overflow-y-auto rounded-md border border-border/60 bg-popover p-1 text-popover-foreground shadow-[0_8px_28px_-12px_oklch(0_0_0/0.45)] outline-none",
...
function ContextMenuItem({
  ...
  return (
    <ContextMenuPrimitive.Item
      ...
      className={cn(
        "group/context-menu-item relative flex cursor-default items-center gap-2 rounded-[3px] px-2 py-1.5 text-[13px] leading-5 outline-hidden select-none transition-colors",
...
function ContextMenuSubTrigger({
  ...
  return (
    <ContextMenuPrimitive.SubmenuTrigger
      ...
      data-inset={inset}
      className={cn(
        "flex cursor-default items-center gap-2 rounded-[3px] px-2 py-1.5 text-[13px] leading-5 outline-hidden select-none transition-colors focus:bg-accent focus:text-accent-foreground data-inset:pl-7 data-open:bg-accent data-open:text-accent-foreground [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
        className,
      )}
      {...props}
    >
...
function ContextMenuShortcut({
  ...
  return (
    <span
      ...
      className={cn(
        "ml-auto font-mono text-[11px] text-muted-foreground/70 group-focus/context-menu-item:text-accent-foreground",
        className,
      )}
      {...props}
    />
